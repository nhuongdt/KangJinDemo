namespace Model.Migrations
{
    ...
    public partial class UpdateDM_HangHoa_UpdateStoreProcedure_20180312 : DbMigration
    {
        public override void Up()
        {
            AlterStoredProcedure(name: "[dbo].[getList_HoaDonsTraHang]", parametersAction: p => new
            {
                MaHD = p.String(),
                ID_DonVi = p.Guid(),
