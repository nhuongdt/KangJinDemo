var Model_TypeCustomer = function (loaiDT) {
    this.LoaiDoiTuong = ko.observable(loaiDT);
};
var modelLoaiDT = new Model_TypeCustomer(1);
...
; (function (factory) {
    ...
    var JqAutoCustomer = function () {
        ...
        this.processOptions = function (valueAccessor, filter, data, request, response) {
            ...
            timer = setTimeout(function () {
                $.ajax({
                    type: "GET",
                    url: "/api/DanhMuc/Quy_HoaDonAPI/" + "GetListDoiTuongByLoai?loaiDoiTuong=" + modelLoaiDT.LoaiDoiTuong()
    ...
    ko.bindingHandlers.jqAutoCustomer = new JqAutoCustomer();
})
