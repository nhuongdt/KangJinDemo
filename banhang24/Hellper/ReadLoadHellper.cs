...
namespace banhang24.Hellper
{
    ...
    public class commonEnum
    {
        ...
        public static Dictionary<string, string> ListColumnBCGDV_BanDoiTra = new Dictionary<string, string>()
        {
             ...
             { Column_BCGDVBanDoiTra.SoLuongTra.ToString(),"Số lượng" },
             { Column_BCGDVBanDoiTra.GiaTriTra.ToString(),"Giá trị" },

             { Column_BCGDVBanDoiTra.GDVDoi_MaHoaDon.ToString(),"Mã chứng từ" },
             { Column_BCGDVBanDoiTra.GDVDoi_NgayLapHoaDon.ToString(),"Ngày lập" },
        ...
        public static Dictionary<string, string> ListKhachHang = new Dictionary<string, string>()
        {
             ...
             {ColumnKhachHang. diachi.ToString(),"Địa chỉ" },
                ...
                { ColumnKhachHang.tongbantrutrahang.ToString(),"Tổng bán" }, // kangjin: TongBan: lấy giá trị sau khi trả (bỏ cột Tổng bán trừ trả hàng)
         ...
         public static Dictionary<string, string> RpDiscountRevenue_Detail = new Dictionary<string, string>()
        {
             ...
             { TypeRChietKhau.tenhang.ToString(),"Tên hàng/dịch vụ" },
             { TypeRChietKhau.soluong.ToString(),"Số lượng" },
             { TypeRChietKhau.giatritinhck.ToString(),"Thành tiền" },
