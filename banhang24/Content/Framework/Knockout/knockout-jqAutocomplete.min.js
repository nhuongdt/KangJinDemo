    ...
    var JqAutoDTCongViec = function () {
        ...
        this.processOptions = function (valueAccessor, filter, data, request, response) {
            ...
            timer = setTimeout(function () {
                $.ajax({
                    type: "GET",
                    url: "/api/DanhMuc/Quy_HoaDonAPI/" + "GetListDoiTuongByLoai?loaiDoiTuong=" + modelCV.checkDoiTuong()
                        + "&txtSearch=" + request.term + "&idDonVi=" + VHeader.IdDonVi,
                    dataType: 'json',
                    contentType: 'application/json',
                    success: function (result) {
    ...
    var JqAutoSoQuyDTNhapHang = function () {
        ...
        this.processOptions = function (valueAccessor, filter, data, request, response) {
            ...
            timer = setTimeout(function () {
                $.ajax({
                    type: "GET",
                    url: "/api/DanhMuc/Quy_HoaDonAPI/" + "GetListDoiTuongByLoai?loaiDoiTuong=" + 2
                        + "&txtSearch=" + request.term + "&idDonVi=" + VHeader.IdDonVi,
                    dataType: 'json',
                    contentType: 'application/json',
                    success: function (result) {
