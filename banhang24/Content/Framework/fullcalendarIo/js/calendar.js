...
(function ($) {
    ...
    Calendar.prototype._update = function () {
        ...
        $('.cal-cell').dblclick(function () {
            //var view = $('[data-toggle]', this).data('cal-view');
        ...
        this._update_modal();
        $('.cal-day-hour-part').click(function (item) {  // time in day
            creat_lichhen($(this).text().trim(),1)
            $('#myModallichhen').modal('show');

        });
        $(".cal-row-fluid").find('div [class ^= cal-cell]').click(function () {// day in week
            self.options.day = $('[data-cal-date]', this).data('cal-date');
            var date = self.options.day;
            creat_lichhen(date, 2);
        });
        $(".cal-day-inmonth").click(function () {// day in month
            self.options.day = $('[data-cal-date]', this).data('cal-date');
            var date = self.options.day;
            creat_lichhen(date, 3);
        });
    };
    ...
    Calendar.prototype._update_modal = function () {
        ...
        $('a[data-event-id]', this.context).on('click', function (event) {
            ...
            if (self.options.modal_type == "userdefine") {
                update_lichhen(id);
            }
            else {
