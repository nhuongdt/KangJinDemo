...
namespace Ssoft.Common.Common
{
    public class StaticVariable
    {
      ...
      { "á", "à", "ả", "ã", "ạ", "â", "ấ", "ầ", "ẩ", "ẫ", "ậ", "ă", "ắ", "ằ", "ẳ", "ẵ", "ặ",
        ...
        public static int GetDeviceType(string ua)
        {
            ...
            {
                return (int)LibEnum.Device.tablet;
            }
            ...
            {
                return (int)LibEnum.Device.mobile;
            }
            ...
            {
                return (int)LibEnum.Device.desktop;
            }
        ...
        public static string GetSitemapDocument(IEnumerable<SitemapNode> sitemapNodes)
        {
            ...
            XElement root = new XElement(xmlns + "urlset", new XAttribute(XNamespace.Xmlns + "xsi", xsi), new XAttribute(xsi + "schemaLocation", schemaLocation));
    ...
    public static class GridPagedingHellper
    {
        ...
        {
            return string.Format("Trang {0} / {1} ({2} bản ghi)", page, pageCount, rowCount);
        }
        ...
        public static string PageContactItems(int page, int limit, int rowCount)
        {
            return string.Format("{0} - {1} of {2} )", ((page -1)* limit) +1, page * limit, rowCount);
        }
